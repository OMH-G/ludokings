  ...
  return (
    <header className="absolute inset-x-0 top-0 z-50">
      ...
      >
        ...
        <Dialog.Panel className="fixed inset-y-0 right-0 z-50 w-full h-2/3 border border-b-1 rounded-md text-center overflow-y-auto bg-gray-50 px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
            ...
            <div className="-my-6 divide-y divide-gray-500/10">
              <div className="space-y-2 py-2">
                {navLinks.map((link) => (
                  ...
                  >
                    {link.label}
                    <hr className="m-auto w-1/2 border border-b-gray-100 bg-gray-100 text-center" />
                  </Link>
                ))}
              </div>
            </div>
